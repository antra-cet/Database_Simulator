...
public final class Constants {
    ...
    // More constants added for the project
    public static final String OUTPUT_DIR = "output";
    public static final String TESTS_PATH = "tests";
    public static final String OUT_FILE = "src/main/test.txt";
    public static final int TEST_LENGTH = 4;
    public static final int JSON_LENGTH = 5;
    public static final double START_AVERAGE_SCORE = 10.0;
